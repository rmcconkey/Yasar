...
public class ContactsFragment extends Fragment implements OnItemClickListener,
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		addContactBtn.setOnClickListener(addContact(acTextView));

		// Setup adapter for respond listview
		respondListView = (ListView) getActivity().findViewById(R.id.listView1);

		// Create list from contacts in database then at to adapter
	...
	private OnClickListener addContact(final AutoCompleteTextView actv) {
